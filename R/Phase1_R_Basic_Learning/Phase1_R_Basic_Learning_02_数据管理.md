...
![](Phase1_R_Basic_Learning_02_数据管理_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
> rnorm(50, mean=50, sd=10) # 生成 50 个均值为 50,标准差为 10 的正态随机数
 [1] 52.79 36.73 45.13 35.27 50.99 52.49 33.30 41.49 53.48 55.10 41.69 29.36
[13] 44.82 67.98 47.51 55.38 52.01 64.87 56.48 48.69 50.65 52.14 47.91 55.69
[25] 35.30 57.43 41.93 60.99 44.00 51.63 67.65 67.20 63.37 41.41 42.71 53.33
[37] 58.37 40.07 53.35 55.64 51.94 50.61 39.66 53.45 53.88 57.04 22.04 51.78
[49] 60.93 50.16
```
...
``` r
> runif(5)
[1] 0.5443 0.8550 0.0729 0.1093 0.0184
```

``` r
> runif(5)
[1] 0.06989 0.40590 0.08740 0.76839 0.27606
```
