...
> summary(x) # 生成了此数据的摘要统计量
  ...
  0.121   0.337   0.521   0.534   0.748   0.988 
> hist(x) # 生成了此数据的直方图
```

![](Phase1_R_Basic_Learning_01_初识R语言_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](Phase1_R_Basic_Learning_01_初识R语言_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](Phase1_R_Basic_Learning_01_初识R语言_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->

``` r
> heatmap(data, scale="column", col = terrain.colors(256),Colv = NA, Rowv = NA)
```

![](Phase1_R_Basic_Learning_01_初识R语言_files/figure-gfm/unnamed-chunk-15-3.png)<!-- -->
