...
- [1\_1.1 R的使用](#1_11-r的使用)
  - [1\_1.1.1 工作空间](#1_111-工作空间)
- [1\_1.2 包](#1_12-包)
  - [1\_1.2.1 什么是包](#1_121-什么是包)
  - [1\_1.2.2 包的安装](#1_122-包的安装)
  - [1\_1.2.3 包的载入](#1_123-包的载入)
  - [1\_1.2.4 获取帮助](#1_124-获取帮助)
- [1\_2.1 数据集的概念](#1_21-数据集的概念)
- [1\_2.2 数据结构](#1_22-数据结构)
  - [1\_2.2.1 向量](#1_221-向量)
  - [1\_2.2.2 矩阵](#1_222-矩阵)
  - [1\_2.2.3 数组](#1_223-数组)
  - [1\_2.2.4 数据框](#1_224-数据框)
  - [1\_2.2.5 因子](#1_225-因子)
  - [1\_2.2.6 列表](#1_226-列表)
- [1\_2.3 数据的输入](#1_23-数据的输入)
  - [1\_2.3.1 导入带分隔符的文本文件](#1_231-导入带分隔符的文本文件)
  - [1\_2.3.2 导入Excel电子表格](#1_232-导入excel电子表格)
  - [1\_2.3.3 导入SPSS文件](#1_233-导入spss文件)
- [1\_2.4 数据的导出](#1_24-数据的导出)
  - [1\_2.4.1 导出符号分隔文本文件](#1_241-导出符号分隔文本文件)
  - [1\_2.4.2 导出Excel电子表格](#1_242-导出excel电子表格)
  - [1\_2.4.3 导出给统计学程序](#1_243-导出给统计学程序)
- [1\_2.5 处理数据对象的实用函数](#1_25-处理数据对象的实用函数)
...
> summary(x) # 生成了此数据的摘要统计量
  ...
  0.015   0.316   0.504   0.508   0.779   0.990 
> hist(x) # 生成了此数据的直方图
```

![](Phase1_R_Basic_Learning_1_初识R语言_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
![](Phase1_R_Basic_Learning_1_初识R语言_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
![](Phase1_R_Basic_Learning_1_初识R语言_files/figure-html/unnamed-chunk-15-2.png)<!-- -->

```r
> heatmap(data, scale="column", col = terrain.colors(256),Colv = NA, Rowv = NA)
```

![](Phase1_R_Basic_Learning_1_初识R语言_files/figure-html/unnamed-chunk-15-3.png)<!-- -->
