...
![](Phase1_R_Basic_Learning_2_数据管理_files/figure-html/unnamed-chunk-34-1.png)<!-- -->
...
> rnorm(50, mean=50, sd=10) # 生成 50 个均值为 50,标准差为 10 的正态随机数
 [1] 31.89 46.93 55.46 51.54 46.73 50.39 55.98 60.37 49.59 67.36 51.76 45.95
[13] 33.06 44.96 43.16 69.37 49.09 70.10 49.11 47.57 63.34 40.08 65.89 53.20
[25] 52.61 46.48 42.18 50.99 52.74 53.73 48.25 57.47 41.08 40.51 57.27 66.26
[37] 36.49 41.32 39.90 40.55 39.66 37.42 38.97 48.24 46.00 57.69 46.93 61.33
[49] 45.99 75.05
```
...
```r
> runif(5)
[1] 0.3144 0.8364 0.4692 0.7186 0.3324
```


```r
> runif(5)
[1] 0.48859 0.50006 0.82928 0.05144 0.51593
```
