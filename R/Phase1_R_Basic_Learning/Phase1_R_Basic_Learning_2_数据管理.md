...
Time difference of 3452.857 weeks
```
...
> rnorm(50, mean=50, sd=10) # 生成 50 个均值为 50,标准差为 10 的正态随机数
 [1] 56.48 58.04 44.73 43.57 50.91 54.15 61.14 48.56 58.56 70.18 55.09 56.41
[13] 44.14 58.12 61.62 62.73 27.15 60.38 47.90 54.73 50.29 41.61 44.49 57.12
[25] 42.55 56.83 69.36 58.49 53.38 70.08 60.47 62.46 42.87 38.90 67.89 49.59
[37] 55.00 56.66 67.95 53.86 69.15 40.43 43.03 56.71 51.58 47.71 57.14 46.32
[49] 38.91 41.62
```
...
``` r
> runif(5)
[1] 0.9392 0.8835 0.7244 0.9902 0.4813
```

``` r
> runif(5)
[1] 0.98527 0.49073 0.07126 0.05818 0.37378
```
