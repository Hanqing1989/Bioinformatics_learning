...
> rnorm(50, mean=50, sd=10) # 生成 50 个均值为 50,标准差为 10 的正态随机数
 [1] 62 51 44 51 41 49 53 42 64 71 39 47 51 42 51 57 48 42 38 44 62 36 44 37 53
[26] 49 36 54 60 41 48 46 50 36 47 34 62 72 52 50 40 33 26 62 58 62 58 57 50 63
```
...
``` r
> runif(5)
[1] 0.103 0.727 0.212 0.763 0.085
```

``` r
> runif(5)
[1] 0.95 0.99 0.87 0.52 0.59
```
