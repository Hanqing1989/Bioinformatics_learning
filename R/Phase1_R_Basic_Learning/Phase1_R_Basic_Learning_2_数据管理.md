...
> rnorm(50, mean=50, sd=10) # 生成 50 个均值为 50,标准差为 10 的正态随机数
 [1] 67 52 44 51 54 44 44 26 48 42 53 73 47 40 38 57 60 45 46 64 45 53 61 62 36
[26] 57 52 50 54 43 67 53 44 42 45 83 64 41 53 53 48 62 62 30 47 48 46 66 58 40
```
...
``` r
> runif(5)
[1] 0.89 0.60 0.14 0.77 0.72
```

``` r
> runif(5)
[1] 0.544 0.885 0.644 0.836 0.029
```
